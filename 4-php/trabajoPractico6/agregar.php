...
if(isset($_POST['enviar'])){
	...
	$guardar = mysqli_query($con, "INSERT INTO tblusuarios(usuario,nombre,sexo,nivel,email,telefono,marca,compania,saldo,activo,hora) 
	VALUES('$user','$nombre','$sexo','$nivel','$mail','$tel','$marca','$compañia','$saldo','$activo','$hora')" );
